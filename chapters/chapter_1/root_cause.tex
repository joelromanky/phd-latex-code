...
In this thesis, Chapter \ref{chap:diagnosis} proposes a two-stage approach for RCD of Cloud VR applications. By leveraging contrastive anomaly detection techniques, our approach achieves strong diagnostic results, even with minimal labeled data, while maintaining reasonable training and inference times.

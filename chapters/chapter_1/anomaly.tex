...
\begin{itemize}
    ...
    \end{equation}
    % rajouter le MCC
    \item \textbf{MCC.} \ac{MCC} is a binary classification metric that addresses the class invariance limitation of the F1-score. It evaluates model performance by equally rewarding accurate predictions for both the positive and negative classes.
    \begin{equation}

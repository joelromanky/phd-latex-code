...
\begin{itemize}
    \item A stochastic data augmentation module that transforms each input window time series $w_t$ to three views: two positive views $\{w_i^{+}; w_{i+N}^{+}\}$ and a negative view $w_i^{-}$.

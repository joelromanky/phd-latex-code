...
\begin{itemize}
    ...
    \textbf{OpenData:} \url{https://cloud-gaming-traces.lhs.inria.fr/data.html}
    }
    ...
    \textbf{Code:} \url{https://github.com/joelromanky/cg-ano-detect-eval}
    }
    ...
    \textbf{Code:} \url{https://github.com/joelromanky/unsupervised-ml-ad-qoe-deg}
    }
    ...
    \textbf{Code:} \url{https://github.com/joelromanky/cats}
    }
    ...
    % \joel{TODO}
    \squarebox[Gray]{
    \textbf{RAID: Root cause Anomaly Identification and Diagnosis}
    
    Joël Roman Ky, Bertrand Mathieu, Abdelkader Lahmadi, Minqi Wang, Nicolas Marrot and Raouf Boutaba.
    
    \textit{Under review at European Conference on Machine Learning and Principles and Practice of Knowledge Discovery in Databases (ECML PKDD 2025).}

    \textbf{Code:} \url{https://github.com/joelromanky/raid}
    }

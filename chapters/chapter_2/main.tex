\squarebox[LightBlue]{
\chapterabstract{This chapter presents the methodologies and experiments used for collecting datasets to train machine learning models for anomaly detection and root cause diagnosis in low-latency applications. We conducted three data collection experiments, each performed in a lab environment, with careful attention to ensuring they were both reproducible and as realistic as possible.
...
These datasets form the foundation for the machine learning models developed and evaluated in subsequent chapters.}}
